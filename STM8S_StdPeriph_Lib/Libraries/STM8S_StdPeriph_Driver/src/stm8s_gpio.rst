      ...
      0094BF 16 03            [ 2]   64 	ldw	y, (0x03, sp)
      0094C1 90 7F            [ 1]   65 	clr	(y)
      ...
      0094C3 93               [ 1]   67 	ldw	x, y
      0094C4 5C               [ 1]   68 	incw	x
      0094C5 5C               [ 1]   69 	incw	x
      0094C6 7F               [ 1]   70 	clr	(x)
      ...
      0094C7 93               [ 1]   72 	ldw	x, y
      0094C8 6F 03            [ 1]   73 	clr	(0x0003, x)
      ...
      0094CA 93               [ 1]   75 	ldw	x, y
      0094CB 6F 04            [ 1]   76 	clr	(0x0004, x)
      ...
      0094CD 81               [ 4]   78 	ret
                                     ...
                                     82 ;	-----------------------------------------
      0094CE                         83 _GPIO_Init:
      0094CE 52 05            [ 2]   84 	sub	sp, #5
                                     85 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 81: GPIOx->CR2 &= (uint8_t)(~(GPIO_Pin));
      0094D0 16 08            [ 2]   86 	ldw	y, (0x08, sp)
      0094D2 93               [ 1]   87 	ldw	x, y
      0094D3 1C 00 04         [ 2]   88 	addw	x, #0x0004
      0094D6 1F 01            [ 2]   89 	ldw	(0x01, sp), x
      0094D8 F6               [ 1]   90 	ld	a, (x)
      0094D9 88               [ 1]   91 	push	a
      0094DA 7B 0B            [ 1]   92 	ld	a, (0x0b, sp)
      0094DC 43               [ 1]   93 	cpl	a
      0094DD 6B 06            [ 1]   94 	ld	(0x06, sp), a
      0094DF 84               [ 1]   95 	pop	a
      0094E0 14 05            [ 1]   96 	and	a, (0x05, sp)
      0094E2 1E 01            [ 2]   97 	ldw	x, (0x01, sp)
      0094E4 F7               [ 1]   98 	ld	(x), a
                                     99 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 98: GPIOx->DDR |= (uint8_t)GPIO_Pin;
      0094E5 93               [ 1]  100 	ldw	x, y
      0094E6 5C               [ 1]  101 	incw	x
      0094E7 5C               [ 1]  102 	incw	x
      0094E8 1F 03            [ 2]  103 	ldw	(0x03, sp), x
      ...
      0094F0 88               [ 1]  110 	push	a
      0094F1 7B 0C            [ 1]  111 	ld	a, (0x0c, sp)
      0094F3 A5 10            [ 1]  112 	bcp	a, #0x10
      0094F5 84               [ 1]  113 	pop	a
      0094F6 27 06            [ 1]  114 	jreq	00102$
                                    115 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 91: GPIOx->ODR |= (uint8_t)GPIO_Pin;
      0094F8 1A 0A            [ 1]  116 	or	a, (0x0a, sp)
      0094FA 90 F7            [ 1]  117 	ld	(y), a
      0094FC 20 04            [ 2]  118 	jra	00103$
      0094FE                        119 00102$:
                                    120 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 95: GPIOx->ODR &= (uint8_t)(~(GPIO_Pin));
      0094FE 14 05            [ 1]  121 	and	a, (0x05, sp)
      009500 90 F7            [ 1]  122 	ld	(y), a
      009502                        123 00103$:
                                    124 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 98: GPIOx->DDR |= (uint8_t)GPIO_Pin;
      009502 1E 03            [ 2]  125 	ldw	x, (0x03, sp)
      009504 F6               [ 1]  126 	ld	a, (x)
      009505 1A 0A            [ 1]  127 	or	a, (0x0a, sp)
      009507 1E 03            [ 2]  128 	ldw	x, (0x03, sp)
      009509 F7               [ 1]  129 	ld	(x), a
      00950A 20 08            [ 2]  130 	jra	00106$
      00950C                        131 00105$:
                                    132 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 103: GPIOx->DDR &= (uint8_t)(~(GPIO_Pin));
      00950C 1E 03            [ 2]  133 	ldw	x, (0x03, sp)
      00950E F6               [ 1]  134 	ld	a, (x)
      00950F 14 05            [ 1]  135 	and	a, (0x05, sp)
      009511 1E 03            [ 2]  136 	ldw	x, (0x03, sp)
      009513 F7               [ 1]  137 	ld	(x), a
      009514                        138 00106$:
                                    139 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 112: GPIOx->CR1 |= (uint8_t)GPIO_Pin;
      009514 93               [ 1]  140 	ldw	x, y
      009515 1C 00 03         [ 2]  141 	addw	x, #0x0003
      009518 F6               [ 1]  142 	ld	a, (x)
      ...
      009519 88               [ 1]  144 	push	a
      00951A 7B 0C            [ 1]  145 	ld	a, (0x0c, sp)
      00951C A5 40            [ 1]  146 	bcp	a, #0x40
      00951E 84               [ 1]  147 	pop	a
      00951F 27 05            [ 1]  148 	jreq	00108$
                                    149 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 112: GPIOx->CR1 |= (uint8_t)GPIO_Pin;
      009521 1A 0A            [ 1]  150 	or	a, (0x0a, sp)
      009523 F7               [ 1]  151 	ld	(x), a
      009524 20 03            [ 2]  152 	jra	00109$
      009526                        153 00108$:
                                    154 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 116: GPIOx->CR1 &= (uint8_t)(~(GPIO_Pin));
      009526 14 05            [ 1]  155 	and	a, (0x05, sp)
      009528 F7               [ 1]  156 	ld	(x), a
      009529                        157 00109$:
                                    158 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 81: GPIOx->CR2 &= (uint8_t)(~(GPIO_Pin));
      009529 1E 01            [ 2]  159 	ldw	x, (0x01, sp)
      00952B F6               [ 1]  160 	ld	a, (x)
      ...
      00952C 88               [ 1]  162 	push	a
      00952D 7B 0C            [ 1]  163 	ld	a, (0x0c, sp)
      00952F A5 20            [ 1]  164 	bcp	a, #0x20
      009531 84               [ 1]  165 	pop	a
      009532 27 07            [ 1]  166 	jreq	00111$
                                    167 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 125: GPIOx->CR2 |= (uint8_t)GPIO_Pin;
      009534 1A 0A            [ 1]  168 	or	a, (0x0a, sp)
      009536 1E 01            [ 2]  169 	ldw	x, (0x01, sp)
      009538 F7               [ 1]  170 	ld	(x), a
      009539 20 05            [ 2]  171 	jra	00113$
      00953B                        172 00111$:
                                    173 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 129: GPIOx->CR2 &= (uint8_t)(~(GPIO_Pin));
      00953B 14 05            [ 1]  174 	and	a, (0x05, sp)
      00953D 1E 01            [ 2]  175 	ldw	x, (0x01, sp)
      00953F F7               [ 1]  176 	ld	(x), a
      009540                        177 00113$:
                                    178 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 131: }
      009540 5B 05            [ 2]  179 	addw	sp, #5
      009542 81               [ 4]  180 	ret
                                    ...
                                    184 ;	-----------------------------------------
      009543                        185 _GPIO_Write:
                                    186 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 143: GPIOx->ODR = PortVal;
      009543 1E 03            [ 2]  187 	ldw	x, (0x03, sp)
      009545 7B 05            [ 1]  188 	ld	a, (0x05, sp)
      009547 F7               [ 1]  189 	ld	(x), a
      ...
      009548 81               [ 4]  191 	ret
                                    ...
                                    195 ;	-----------------------------------------
      009549                        196 _GPIO_WriteHigh:
                                    197 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 156: GPIOx->ODR |= (uint8_t)PortPins;
      009549 1E 03            [ 2]  198 	ldw	x, (0x03, sp)
      00954B F6               [ 1]  199 	ld	a, (x)
      00954C 1A 05            [ 1]  200 	or	a, (0x05, sp)
      00954E F7               [ 1]  201 	ld	(x), a
      ...
      00954F 81               [ 4]  203 	ret
                                    ...
                                    207 ;	-----------------------------------------
      009550                        208 _GPIO_WriteLow:
      009550 88               [ 1]  209 	push	a
                                    210 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 169: GPIOx->ODR &= (uint8_t)(~PortPins);
      009551 1E 04            [ 2]  211 	ldw	x, (0x04, sp)
      009553 F6               [ 1]  212 	ld	a, (x)
      009554 6B 01            [ 1]  213 	ld	(0x01, sp), a
      009556 7B 06            [ 1]  214 	ld	a, (0x06, sp)
      009558 43               [ 1]  215 	cpl	a
      009559 14 01            [ 1]  216 	and	a, (0x01, sp)
      00955B F7               [ 1]  217 	ld	(x), a
                                    218 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 170: }
      00955C 84               [ 1]  219 	pop	a
      00955D 81               [ 4]  220 	ret
                                    ...
                                    224 ;	-----------------------------------------
      00955E                        225 _GPIO_WriteReverse:
                                    226 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 182: GPIOx->ODR ^= (uint8_t)PortPins;
      00955E 1E 03            [ 2]  227 	ldw	x, (0x03, sp)
      009560 F6               [ 1]  228 	ld	a, (x)
      009561 18 05            [ 1]  229 	xor	a, (0x05, sp)
      009563 F7               [ 1]  230 	ld	(x), a
      ...
      00956E 1E 03            [ 2]  259 	ldw	x, (0x03, sp)
      009570 E6 01            [ 1]  260 	ld	a, (0x1, x)
      009572 14 05            [ 1]  261 	and	a, (0x05, sp)
