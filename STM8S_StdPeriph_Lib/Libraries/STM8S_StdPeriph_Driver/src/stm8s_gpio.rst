      ...
      008C3D 16 03            [ 2]   64 	ldw	y, (0x03, sp)
      008C3F 90 7F            [ 1]   65 	clr	(y)
      ...
      008C41 93               [ 1]   67 	ldw	x, y
      008C42 5C               [ 1]   68 	incw	x
      008C43 5C               [ 1]   69 	incw	x
      008C44 7F               [ 1]   70 	clr	(x)
      ...
      008C45 93               [ 1]   72 	ldw	x, y
      008C46 6F 03            [ 1]   73 	clr	(0x0003, x)
      ...
      008C48 93               [ 1]   75 	ldw	x, y
      008C49 6F 04            [ 1]   76 	clr	(0x0004, x)
      ...
      008C4B 81               [ 4]   78 	ret
                                     ...
                                     82 ;	-----------------------------------------
      008C4C                         83 _GPIO_Init:
      008C4C 52 05            [ 2]   84 	sub	sp, #5
                                     85 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 81: GPIOx->CR2 &= (uint8_t)(~(GPIO_Pin));
      008C4E 16 08            [ 2]   86 	ldw	y, (0x08, sp)
      008C50 93               [ 1]   87 	ldw	x, y
      008C51 1C 00 04         [ 2]   88 	addw	x, #0x0004
      008C54 1F 01            [ 2]   89 	ldw	(0x01, sp), x
      008C56 F6               [ 1]   90 	ld	a, (x)
      008C57 88               [ 1]   91 	push	a
      008C58 7B 0B            [ 1]   92 	ld	a, (0x0b, sp)
      008C5A 43               [ 1]   93 	cpl	a
      008C5B 6B 06            [ 1]   94 	ld	(0x06, sp), a
      008C5D 84               [ 1]   95 	pop	a
      008C5E 14 05            [ 1]   96 	and	a, (0x05, sp)
      008C60 1E 01            [ 2]   97 	ldw	x, (0x01, sp)
      008C62 F7               [ 1]   98 	ld	(x), a
                                     99 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 98: GPIOx->DDR |= (uint8_t)GPIO_Pin;
      008C63 93               [ 1]  100 	ldw	x, y
      008C64 5C               [ 1]  101 	incw	x
      008C65 5C               [ 1]  102 	incw	x
      008C66 1F 03            [ 2]  103 	ldw	(0x03, sp), x
      ...
      008C6E 88               [ 1]  110 	push	a
      008C6F 7B 0C            [ 1]  111 	ld	a, (0x0c, sp)
      008C71 A5 10            [ 1]  112 	bcp	a, #0x10
      008C73 84               [ 1]  113 	pop	a
      008C74 27 06            [ 1]  114 	jreq	00102$
                                    115 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 91: GPIOx->ODR |= (uint8_t)GPIO_Pin;
      008C76 1A 0A            [ 1]  116 	or	a, (0x0a, sp)
      008C78 90 F7            [ 1]  117 	ld	(y), a
      008C7A 20 04            [ 2]  118 	jra	00103$
      008C7C                        119 00102$:
                                    120 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 95: GPIOx->ODR &= (uint8_t)(~(GPIO_Pin));
      008C7C 14 05            [ 1]  121 	and	a, (0x05, sp)
      008C7E 90 F7            [ 1]  122 	ld	(y), a
      008C80                        123 00103$:
                                    124 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 98: GPIOx->DDR |= (uint8_t)GPIO_Pin;
      008C80 1E 03            [ 2]  125 	ldw	x, (0x03, sp)
      008C82 F6               [ 1]  126 	ld	a, (x)
      008C83 1A 0A            [ 1]  127 	or	a, (0x0a, sp)
      008C85 1E 03            [ 2]  128 	ldw	x, (0x03, sp)
      008C87 F7               [ 1]  129 	ld	(x), a
      008C88 20 08            [ 2]  130 	jra	00106$
      008C8A                        131 00105$:
                                    132 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 103: GPIOx->DDR &= (uint8_t)(~(GPIO_Pin));
      008C8A 1E 03            [ 2]  133 	ldw	x, (0x03, sp)
      008C8C F6               [ 1]  134 	ld	a, (x)
      008C8D 14 05            [ 1]  135 	and	a, (0x05, sp)
      008C8F 1E 03            [ 2]  136 	ldw	x, (0x03, sp)
      008C91 F7               [ 1]  137 	ld	(x), a
      008C92                        138 00106$:
                                    139 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 112: GPIOx->CR1 |= (uint8_t)GPIO_Pin;
      008C92 93               [ 1]  140 	ldw	x, y
      008C93 1C 00 03         [ 2]  141 	addw	x, #0x0003
      008C96 F6               [ 1]  142 	ld	a, (x)
      ...
      008C97 88               [ 1]  144 	push	a
      008C98 7B 0C            [ 1]  145 	ld	a, (0x0c, sp)
      008C9A A5 40            [ 1]  146 	bcp	a, #0x40
      008C9C 84               [ 1]  147 	pop	a
      008C9D 27 05            [ 1]  148 	jreq	00108$
                                    149 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 112: GPIOx->CR1 |= (uint8_t)GPIO_Pin;
      008C9F 1A 0A            [ 1]  150 	or	a, (0x0a, sp)
      008CA1 F7               [ 1]  151 	ld	(x), a
      008CA2 20 03            [ 2]  152 	jra	00109$
      008CA4                        153 00108$:
                                    154 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 116: GPIOx->CR1 &= (uint8_t)(~(GPIO_Pin));
      008CA4 14 05            [ 1]  155 	and	a, (0x05, sp)
      008CA6 F7               [ 1]  156 	ld	(x), a
      008CA7                        157 00109$:
                                    158 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 81: GPIOx->CR2 &= (uint8_t)(~(GPIO_Pin));
      008CA7 1E 01            [ 2]  159 	ldw	x, (0x01, sp)
      008CA9 F6               [ 1]  160 	ld	a, (x)
      ...
      008CAA 88               [ 1]  162 	push	a
      008CAB 7B 0C            [ 1]  163 	ld	a, (0x0c, sp)
      008CAD A5 20            [ 1]  164 	bcp	a, #0x20
      008CAF 84               [ 1]  165 	pop	a
      008CB0 27 07            [ 1]  166 	jreq	00111$
                                    167 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 125: GPIOx->CR2 |= (uint8_t)GPIO_Pin;
      008CB2 1A 0A            [ 1]  168 	or	a, (0x0a, sp)
      008CB4 1E 01            [ 2]  169 	ldw	x, (0x01, sp)
      008CB6 F7               [ 1]  170 	ld	(x), a
      008CB7 20 05            [ 2]  171 	jra	00113$
      008CB9                        172 00111$:
                                    173 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 129: GPIOx->CR2 &= (uint8_t)(~(GPIO_Pin));
      008CB9 14 05            [ 1]  174 	and	a, (0x05, sp)
      008CBB 1E 01            [ 2]  175 	ldw	x, (0x01, sp)
      008CBD F7               [ 1]  176 	ld	(x), a
      008CBE                        177 00113$:
                                    178 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 131: }
      008CBE 5B 05            [ 2]  179 	addw	sp, #5
      008CC0 81               [ 4]  180 	ret
                                    ...
                                    184 ;	-----------------------------------------
      008CC1                        185 _GPIO_Write:
                                    186 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 143: GPIOx->ODR = PortVal;
      008CC1 1E 03            [ 2]  187 	ldw	x, (0x03, sp)
      008CC3 7B 05            [ 1]  188 	ld	a, (0x05, sp)
      008CC5 F7               [ 1]  189 	ld	(x), a
      ...
      008CC6 81               [ 4]  191 	ret
                                    ...
                                    195 ;	-----------------------------------------
      008CC7                        196 _GPIO_WriteHigh:
                                    197 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 156: GPIOx->ODR |= (uint8_t)PortPins;
      008CC7 1E 03            [ 2]  198 	ldw	x, (0x03, sp)
      008CC9 F6               [ 1]  199 	ld	a, (x)
      008CCA 1A 05            [ 1]  200 	or	a, (0x05, sp)
      008CCC F7               [ 1]  201 	ld	(x), a
      ...
      008CCD 81               [ 4]  203 	ret
                                    ...
                                    207 ;	-----------------------------------------
      008CCE                        208 _GPIO_WriteLow:
      008CCE 88               [ 1]  209 	push	a
                                    210 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 169: GPIOx->ODR &= (uint8_t)(~PortPins);
      008CCF 1E 04            [ 2]  211 	ldw	x, (0x04, sp)
      008CD1 F6               [ 1]  212 	ld	a, (x)
      008CD2 6B 01            [ 1]  213 	ld	(0x01, sp), a
      008CD4 7B 06            [ 1]  214 	ld	a, (0x06, sp)
      008CD6 43               [ 1]  215 	cpl	a
      008CD7 14 01            [ 1]  216 	and	a, (0x01, sp)
      008CD9 F7               [ 1]  217 	ld	(x), a
                                    218 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 170: }
      008CDA 84               [ 1]  219 	pop	a
      008CDB 81               [ 4]  220 	ret
                                    ...
                                    224 ;	-----------------------------------------
      008CDC                        225 _GPIO_WriteReverse:
                                    226 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_gpio.c: 182: GPIOx->ODR ^= (uint8_t)PortPins;
      008CDC 1E 03            [ 2]  227 	ldw	x, (0x03, sp)
      008CDE F6               [ 1]  228 	ld	a, (x)
      008CDF 18 05            [ 1]  229 	xor	a, (0x05, sp)
      008CE1 F7               [ 1]  230 	ld	(x), a
      ...
      008CEC 1E 03            [ 2]  259 	ldw	x, (0x03, sp)
      008CEE E6 01            [ 1]  260 	ld	a, (0x1, x)
      008CF0 14 05            [ 1]  261 	and	a, (0x05, sp)
