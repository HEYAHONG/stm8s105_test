      ...
      0099AC 81               [ 4]   63 	ret
                                     ...
                                     67 ;	-----------------------------------------
      0099AD                         68 _EXTI_SetExtIntSensitivity:
      0099AD 52 02            [ 2]   69 	sub	sp, #2
                                     70 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 77: switch (Port)
      0099AF 7B 05            [ 1]   71 	ld	a, (0x05, sp)
      0099B1 A1 04            [ 1]   72 	cp	a, #0x04
      0099B3 23 03            [ 2]   73 	jrule	00115$
      0099B5 CC 9A 3C         [ 2]   74 	jp	00108$
      0099B8                         75 00115$:
                                     76 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 85: EXTI->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 2);
      0099B8 7B 06            [ 1]   77 	ld	a, (0x06, sp)
      0099BA 90 97            [ 1]   78 	ld	yl, a
                                     79 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 77: switch (Port)
      0099BC 5F               [ 1]   80 	clrw	x
      0099BD 7B 05            [ 1]   81 	ld	a, (0x05, sp)
      0099BF 97               [ 1]   82 	ld	xl, a
      0099C0 58               [ 2]   83 	sllw	x
      0099C1 DE 99 C5         [ 2]   84 	ldw	x, (#00116$, x)
      0099C4 FC               [ 2]   85 	jp	(x)
      0099C5                         86 00116$:
      0099C5 99 CF                   87 	.dw	#00101$
      0099C7 99 E1                   88 	.dw	#00102$
      0099C9 99 F8                   89 	.dw	#00103$
      0099CB 9A 11                   90 	.dw	#00104$
      0099CD 9A 2C                   91 	.dw	#00105$
      ...
      0099CF C6 50 A0         [ 1]   95 	ld	a, 0x50a0
      0099D2 A4 FC            [ 1]   96 	and	a, #0xfc
      0099D4 C7 50 A0         [ 1]   97 	ld	0x50a0, a
                                     98 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 81: EXTI->CR1 |= (uint8_t)(SensitivityValue);
      0099D7 C6 50 A0         [ 1]   99 	ld	a, 0x50a0
      0099DA 1A 06            [ 1]  100 	or	a, (0x06, sp)
      0099DC C7 50 A0         [ 1]  101 	ld	0x50a0, a
                                    102 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 82: break;
      0099DF 20 5B            [ 2]  103 	jra	00108$
      ...
      0099E1 C6 50 A0         [ 1]  107 	ld	a, 0x50a0
      0099E4 A4 F3            [ 1]  108 	and	a, #0xf3
      0099E6 C7 50 A0         [ 1]  109 	ld	0x50a0, a
                                    110 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 85: EXTI->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 2);
      0099E9 C6 50 A0         [ 1]  111 	ld	a, 0x50a0
      0099EC 93               [ 1]  112 	ldw	x, y
      0099ED 58               [ 2]  113 	sllw	x
      0099EE 58               [ 2]  114 	sllw	x
      0099EF 89               [ 2]  115 	pushw	x
      0099F0 1A 02            [ 1]  116 	or	a, (2, sp)
      0099F2 85               [ 2]  117 	popw	x
      0099F3 C7 50 A0         [ 1]  118 	ld	0x50a0, a
                                    119 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 86: break;
      0099F6 20 44            [ 2]  120 	jra	00108$
      ...
      0099F8 C6 50 A0         [ 1]  124 	ld	a, 0x50a0
      0099FB A4 CF            [ 1]  125 	and	a, #0xcf
      0099FD C7 50 A0         [ 1]  126 	ld	0x50a0, a
                                    127 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 89: EXTI->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 4);
      009A00 C6 50 A0         [ 1]  128 	ld	a, 0x50a0
      009A03 6B 02            [ 1]  129 	ld	(0x02, sp), a
      009A05 90 9F            [ 1]  130 	ld	a, yl
      009A07 4E               [ 1]  131 	swap	a
      009A08 A4 F0            [ 1]  132 	and	a, #0xf0
      009A0A 1A 02            [ 1]  133 	or	a, (0x02, sp)
      009A0C C7 50 A0         [ 1]  134 	ld	0x50a0, a
                                    135 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 90: break;
      009A0F 20 2B            [ 2]  136 	jra	00108$
      ...
      009A11 C6 50 A0         [ 1]  140 	ld	a, 0x50a0
      009A14 A4 3F            [ 1]  141 	and	a, #0x3f
      009A16 C7 50 A0         [ 1]  142 	ld	0x50a0, a
                                    143 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 93: EXTI->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 6);
      009A19 C6 50 A0         [ 1]  144 	ld	a, 0x50a0
      009A1C 6B 01            [ 1]  145 	ld	(0x01, sp), a
      009A1E 90 9F            [ 1]  146 	ld	a, yl
      009A20 4E               [ 1]  147 	swap	a
      009A21 A4 F0            [ 1]  148 	and	a, #0xf0
      009A23 48               [ 1]  149 	sll	a
      009A24 48               [ 1]  150 	sll	a
      009A25 1A 01            [ 1]  151 	or	a, (0x01, sp)
      009A27 C7 50 A0         [ 1]  152 	ld	0x50a0, a
                                    153 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 94: break;
      009A2A 20 10            [ 2]  154 	jra	00108$
      ...
      009A2C C6 50 A1         [ 1]  158 	ld	a, 0x50a1
      009A2F A4 FC            [ 1]  159 	and	a, #0xfc
      009A31 C7 50 A1         [ 1]  160 	ld	0x50a1, a
                                    161 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 97: EXTI->CR2 |= (uint8_t)(SensitivityValue);
      009A34 C6 50 A1         [ 1]  162 	ld	a, 0x50a1
      009A37 1A 06            [ 1]  163 	or	a, (0x06, sp)
      009A39 C7 50 A1         [ 1]  164 	ld	0x50a1, a
      ...
      009A3E 81               [ 4]  169 	ret
                                    ...
                                    173 ;	-----------------------------------------
      009A3F                        174 _EXTI_SetTLISensitivity:
                                    175 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 117: EXTI->CR2 &= (uint8_t)(~EXTI_CR2_TLIS);
      009A3F C6 50 A1         [ 1]  176 	ld	a, 0x50a1
      009A42 A4 FB            [ 1]  177 	and	a, #0xfb
      009A44 C7 50 A1         [ 1]  178 	ld	0x50a1, a
                                    179 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 118: EXTI->CR2 |= (uint8_t)(SensitivityValue);
      009A47 C6 50 A1         [ 1]  180 	ld	a, 0x50a1
      009A4A 1A 03            [ 1]  181 	or	a, (0x03, sp)
      009A4C C7 50 A1         [ 1]  182 	ld	0x50a1, a
      ...
      009A4F 81               [ 4]  184 	ret
                                    ...
                                    188 ;	-----------------------------------------
      009A50                        189 _EXTI_GetExtIntSensitivity:
                                    190 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 128: uint8_t value = 0;
      009A50 4F               [ 1]  191 	clr	a
                                    192 ;	STM8S_StdPeriph_Lib/Libraries/STM8S_StdPeriph_Driver/src/stm8s_exti.c: 133: switch (Port)
      009A51 88               [ 1]  193 	push	a
      009A52 7B 04            [ 1]  194 	ld	a, (0x04, sp)
      009A54 A1 04            [ 1]  195 	cp	a, #0x04
      009A56 84               [ 1]  196 	pop	a
      009A57 23 01            [ 2]  197 	jrule	00115$
      009A59 81               [ 4]  198 	ret
      009A5A                        199 00115$:
      009A5A 5F               [ 1]  200 	clrw	x
      009A5B 7B 03            [ 1]  201 	ld	a, (0x03, sp)
      009A5D 97               [ 1]  202 	ld	xl, a
      009A5E 58               [ 2]  203 	sllw	x
      009A5F DE 9A 63         [ 2]  204 	ldw	x, (#00116$, x)
      009A62 FC               [ 2]  205 	jp	(x)
      009A63                        206 00116$:
      009A63 9A 6D                  207 	.dw	#00101$
      009A65 9A 73                  208 	.dw	#00102$
      009A67 9A 7B                  209 	.dw	#00103$
      009A69 9A 84                  210 	.dw	#00104$
      009A6B 9A 8F                  211 	.dw	#00105$
      ...
      009A6D C6 50 A0         [ 1]  215 	ld	a, 0x50a0
      009A70 A4 03            [ 1]  216 	and	a, #0x03
      ...
      009A73 C6 50 A0         [ 1]  222 	ld	a, 0x50a0
      009A76 A4 0C            [ 1]  223 	and	a, #0x0c
      009A78 44               [ 1]  224 	srl	a
      009A79 44               [ 1]  225 	srl	a
      ...
      009A7B C6 50 A0         [ 1]  231 	ld	a, 0x50a0
      009A7E A4 30            [ 1]  232 	and	a, #0x30
      009A80 4E               [ 1]  233 	swap	a
      009A81 A4 0F            [ 1]  234 	and	a, #0x0f
      ...
      009A84 C6 50 A0         [ 1]  240 	ld	a, 0x50a0
      009A87 A4 C0            [ 1]  241 	and	a, #0xc0
      009A89 4E               [ 1]  242 	swap	a
      009A8A A4 0F            [ 1]  243 	and	a, #0x0f
      009A8C 44               [ 1]  244 	srl	a
      009A8D 44               [ 1]  245 	srl	a
      ...
      009A8F C6 50 A1         [ 1]  251 	ld	a, 0x50a1
      009A92 A4 03            [ 1]  252 	and	a, #0x03
